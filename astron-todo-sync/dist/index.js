...
const plugin = {
    ...
    description: "MUST create one new todo for every non-instant user message before doing work or using search/write/edit/command tools so UI and HTTP clients can show current task progress.",
    register(api) {
